...
// Data dummy untuk tabel (Ganti nama variabel agar sesuai)
const patients = [
  { id: 1, nama: "Saputra", nik: "123456", telp: "081254345678" },
  { id: 2, nama: "Muhammad Ole", nik: "1234567", telp: "0822123212321" },
];

export default function PasienManagementPage() { // Ganti nama fungsi agar sesuai
  return (
    <AdminLayout>
      {/* Kontainer Utama */}
        ...
        <div className="overflow-x-auto">
          ...
          <table className="min-w-full divide-y divide-neutral-200">
            ...
            <tbody className="bg-white divide-y divide-neutral-100">
              {patients.map((patient, index) => ( // Ganti 'user' menjadi 'patient'
                <tr
                  key={patient.id} // Ganti 'user.id' menjadi 'patient.id'
