  ...
  return (
    <AdminLayout>
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border border-blue-400 max-w-6xl mx-auto min-h-[70vh]">
        ...
        <h1 className="text-2xl font-bold text-center mb-8 text-gray-800">Manajemen Pasien</h1>
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {users.map((user, index) => (
                <tr key={user.id} className={index % 2 === 1 ? 'bg-gray-50' : 'bg-white'}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{user.nik}</td>
