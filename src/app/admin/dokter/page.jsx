...
// Data dummy untuk tabel (pastikan sesuai dengan data dokter asli Anda)
const doctors = [
        ...
        <div className="overflow-x-auto">
          ...
          <table className="min-w-full divide-y divide-neutral-200">
            ...
            <tbody className="bg-white divide-y divide-neutral-100">
              {doctors.map((doctor, index) => ( // Ganti 'user' menjadi 'doctor'
                <tr
                  key={doctor.id} // Ganti 'user.id' menjadi 'doctor.id'
