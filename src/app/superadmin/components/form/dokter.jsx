...
// --- UBAH: Nama fungsi diubah ---
export default function FormDokterSuperAdmin({ initialData }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        console.log("Updating data (Super Admin):", { ...initialData, ...formData });
        // Ganti dengan API call PUT/PATCH Anda
      } else {
        console.log("Creating data (Super Admin):", formData);
        // Ganti dengan API call POST Anda
      }

      // --- UBAH: Path redirect ke /superadmin/dokter ---
