...
export default function ReservasiPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex justify-center items-start py-10 px-4">
        ...
        {patientData ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="mt-3 bg-primary-500 hover:bg-primary-600 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2"
            >
              <Stethoscope size={18} />
              Diagnosa Otomatis
            </button>
            ...
            <div className="flex justify-end mt-6">
              <button
                onClick={handleNext}
                className="bg-primary-800 hover:bg-secondary-600 text-white font-semibold py-2 px-5 rounded-lg flex items-center gap-2"
              >
...
function InputField({ label, value, readOnly = false }) {
  return (
    <div className="flex flex-col">
      <label className="text-neutral-700 font-medium mb-1">{label}</label>
      <input
        type="text"
        value={value}
        readOnly={readOnly}
        className={`border border-neutral-200 rounded-lg p-2.5 text-neutral-700 ${
          readOnly ? "bg-neutral-100" : "focus:ring-2 focus:ring-primary-500"
        }`}
      />
    </div>
  );
